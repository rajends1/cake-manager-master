package com.bank.application.reports;

import com.bank.model.DailyReport;
import java.com.bank.model.Ranking;
import java.com.bank.model.Trade;
...
public class App 
{
	public static ApplicationContext appContext = new ClassPathXmlApplicationContext("com/bank/service/beans.xml");
	//Queue of trades
    ...
    private static void loadQueue(){
    	...
    	for(int i =1;i<=App.appContext.getBeansOfType(com.bank.model.Trade.class).size();i++){
    ...
    private static void processTrade(Trade trade){
    	...
    	if(trade.getTt().getTradeType()==com.bank.model.TradeType.TypeOfTrade.B){
